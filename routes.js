        ...
        var reload=function(){
            ...
            $.getJSON('/api/users/unlink', function(devices){
                ...
                $.each(devices, function(i, device){
                    var item=$('<li class="list-group-item"><button type="button" class="close" title="unlink" aria-label="Close"><span class="fa fa-times" aria-hidden="true"></span></button><h4 class="list-group-item-heading"></h4><p class="list-group-item-text"></p></li>');
            ...
            $.getJSON('/api/users/link', function(devices){
                ...
                $.each(devices, function(i, device){
                    var item=$('<li class="list-group-item"><button type="button" class="close" title="unlink" aria-label="Close"><span class="fa fa-plus" aria-hidden="true"></span></button><h4 class="list-group-item-heading"></h4><p class="list-group-item-text"></p></li>');
